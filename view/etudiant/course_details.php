...
if ((!$enroll->isEnrolled($_GET['id_course'], $_SESSION['user_id'])) == 'false') {
    $_SESSION["error"] = "You can't preview this course , you need to enroll first";
                    ...
                    <?php if (!empty($course['content'])): ?>
                        <div class="course-content mb-4">
                            ...
                            <div class="flex items-center justify-between">
                                <p class="text-gray-700 truncate"><?php echo htmlspecialchars($course['content']); ?></p>
                                <a href="../../uploads/<?php echo htmlspecialchars($course['content']); ?>"
                                    target="_blank"
                                    class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                                    <i class="fas fa-file-pdf mr-2"></i> <!-- Assuming it's a PDF, adjust icon based on file type -->
                                    View Document
                                </a>
                            </div>
                        </div>
